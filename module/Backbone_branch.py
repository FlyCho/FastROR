...
class Backbone(object):
    ...
    def model(self, images, weight_decay=1e-5):
        ...
        # get the feature map from the resnet 50 > end_points
        with slim.arg_scope(resnet_v1.resnet_arg_scope(weight_decay=weight_decay)):
            logits, end_points = resnet_v1.resnet_v1_50(images, is_training=self.is_training, scope='resnet_v1_50')

# ========start to do the different scale feature fusion to the final feature map > g[3]================================
...
# ======================================================================================================================
                ...
                # predict the channel score map about text/non-text
